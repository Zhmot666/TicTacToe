...
class Ui_Frame(object):
    ...
    def retranslateUi(self, Frame):
        ...
        self.PlayerScore.setText(_translate("Frame", "0"))
        self.Colon.setText(_translate("Frame", ":"))
        self.ComputerScore.setText(_translate("Frame", "0"))
        self.ComputerMark.setText(_translate("Frame", "0"))
        self.PlayerMark.setText(_translate("Frame", "X"))
